...
- `docs/guide/getting-started.md`, `docs/guide/catalogues.md`, `docs/guide/sweeps.md`, `docs/guide/analysis.md`, `docs/guide/candidates.md`, `docs/guide/reliability.md`, `docs/guide/nodebooks.md`, `docs/guide/units.md`, `docs/guide/tips-and-tricks.md`, `docs/guide/node-reference.md`, `docs/guide/catalogue-authoring.md` — the guide pages linked from the landing page and from `packages/editor/src/help-links.ts`'s per-node "?" buttons and palette help links. The docs sidebar separates the everyday workflow from advanced analysis and reference material, following the editor's advanced-node boundary. `catalogues.md` explains the student-facing load/search/use lifecycle without documenting any particular catalogue; `analysis.md` is the short “which question are you asking?” map across deterministic and stochastic analysis; `candidates.md` and `reliability.md` explain their cross-cutting concepts in depth; `nodebooks.md` covers the reporting workflow. `tips-and-tricks.md` is UI mechanics rather than product concepts.
