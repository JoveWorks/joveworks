      ...
      detail={
        <div className="output-editor">
          ...
          {output.kind === 'table' ? (
            <label className="wide">
              columns
              {/* Order, per-column decimal figures, marked rows and the CSV
                  export are all in the notebook (Notebook.tsx), where the
                  rendered table actually is — this list is rename and remove
                  only. Export belongs there for the same reason the digits
                  do: what downloads is what the reader is looking at, at the
                  digits they set, and neither is knowable from here. */}
