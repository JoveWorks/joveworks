...
export const UI = {
  en: { language: 'Language', english: 'English', dutch: 'Nederlands', nodeBookSettings: 'NodeBook settings', notebookLanguage: 'Notebook language', appLanguage: 'App language', exportPdf: 'Export PDF…', close: 'Close', settings: 'Settings', restoredAutosave: 'Restored unsaved work from the last session.', keepNodeOpen: 'Keep open', unpinNode: 'Allow auto-collapse', deleteNode: 'Delete this node', nodeHelp: 'Help for this node', scalar: 'value', slider: 'slider', linear: 'linear range', logarithmic: 'log range', renard: 'Renard series', searchPalette: 'equation number, symbol, or what it computes', favourites: 'Favourites', input: 'Input', value: 'value', singleNumber: 'a single number', range: 'range', rangeSummary: 'swept from a start to a stop', list: 'list', listSummary: 'swept over hand-typed values', general: 'General', compare: 'compare', compareSummary: 'a wireable pass/fail verdict', equation: 'equation', equationSummary: 'type one — its ports follow from what it uses', waypoint: 'waypoint', waypointSummary: 'route independent wires through one stop', pack: 'pack', packSummary: 'bundle several wires into one', unpack: 'unpack', unpackSummary: 'split a bundle back into its wires', monteCarlo: 'Monte Carlo', monteCarloGenerator: 'Monte Carlo generator', monteCarloGeneratorSummary: 'draw from a distribution, sample by sample', monteCarloReceiver: 'Monte Carlo receiver', monteCarloReceiverSummary: 'watch samples accumulate and an aggregate converge', output: 'Output', print: 'print', printSummary: 'a value, as text', plot: 'plot', plotSummary: 'a value over a swept range', table: 'table', tableSummary: 'several series as rows, one per column', check: 'check', checkSummary: 'pass or fail against a threshold', thousandsDecimal: 'thousands / decimal', notation: 'notation', numberFormatNote: 'Applies to every value shown or typed in the app. A per-print-node “figures” count still overrides how many significant figures a result shows.', showMinimap: 'show the canvas minimap', typesetMath: 'typeset mathematical notation in titles and notebook text', contourPalette: 'contour colour palette' },
  nl: { language: 'Taal', english: 'English', dutch: 'Nederlands', nodeBookSettings: 'NodeBook-instellingen', notebookLanguage: 'NodeBook-taal', appLanguage: 'App-taal', exportPdf: 'Exporteer pdf…', close: 'Sluiten', settings: 'Instellingen', restoredAutosave: 'Niet-opgeslagen werk uit de vorige sessie hersteld.', keepNodeOpen: 'Open houden', unpinNode: 'Automatisch samenvouwen toestaan', deleteNode: 'Verwijder dit knooppunt', nodeHelp: 'Hulp voor dit knooppunt', scalar: 'waarde', slider: 'schuifregelaar', linear: 'lineair bereik', logarithmic: 'logaritmisch bereik', renard: 'Renard-reeks', searchPalette: 'vergelijkingsnummer, symbool, of wat het berekent', favourites: 'Favorieten', input: 'Invoer', value: 'waarde', singleNumber: 'één getal', range: 'bereik', rangeSummary: 'gesweept van een begin- tot een eindwaarde', list: 'lijst', listSummary: 'gesweept over handmatig ingevoerde waarden', general: 'Algemeen', compare: 'vergelijk', compareSummary: 'een bedraadbaar geslaagd/mislukt-oordeel', equation: 'vergelijking', equationSummary: 'typ er één — de poorten volgen uit wat ze gebruikt', waypoint: 'tussenpunt', waypointSummary: 'leid onafhankelijke draden via één stop', pack: 'bundel', packSummary: 'bundel meerdere draden tot één', unpack: 'ontbundel', unpackSummary: 'splits een bundel terug op in draden', monteCarlo: 'Monte Carlo', monteCarloGenerator: 'Monte Carlo-generator', monteCarloGeneratorSummary: 'trek uit een verdeling, steekproef voor steekproef', monteCarloReceiver: 'Monte Carlo-ontvanger', monteCarloReceiverSummary: 'zie steekproeven zich opstapelen en een aggregaat convergeren', output: 'Uitvoer', print: 'afdrukken', printSummary: 'een waarde als tekst', plot: 'grafiek', plotSummary: 'een waarde over een gesweept bereik', table: 'tabel', tableSummary: 'meerdere reeksen als rijen, één per kolom', check: 'controle', checkSummary: 'geslaagd of mislukt ten opzichte van een drempel', thousandsDecimal: 'duizendtallen / decimaalteken', notation: 'notatie', numberFormatNote: 'Geldt voor elke waarde die in de app wordt getoond of ingevoerd. Het aantal “cijfers” per uitvoerknooppunt blijft bepalen hoeveel significante cijfers een resultaat toont.', showMinimap: 'minikaart van het canvas tonen', typesetMath: 'wiskundige notatie zetten in titels en notitieboektekst', contourPalette: 'kleurenpalet voor contouren' },
} as const;
