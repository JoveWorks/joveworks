...
const DUTCH_PHRASES: Readonly<Record<string, string>> = {
  ...
  'Connect course…': 'Cursus verbinden…', 'Hub address': 'Hub-adres', 'Course slug': 'Cursuscode',
  ...
  'Refresh course material': 'Cursusmateriaal vernieuwen', 'No published material': 'Geen gepubliceerd materiaal',
