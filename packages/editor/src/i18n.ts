...
const DUTCH_PHRASES: Readonly<Record<string, string>> = {
  ...
  'Canvas': 'Canvas', 'Snap nodes to grid': 'Knooppunten aan raster vastklikken', 'Snap to grid': 'Vastklikken aan raster',
  'Enable snap to grid': 'Vastklikken aan raster inschakelen', 'Disable snap to grid': 'Vastklikken aan raster uitschakelen', 'Node': 'Knooppunt',
